...
Commands:
    download        Stage 2: Download climate data from NASA
    ...
    outdoor-summary Stage 8: Outdoor WBGT summary
...
Examples:
    ...
    SHIFTING_WH_DATA_DIR=/path/to/data shifting-wh wbgt-indoor
"""
...
from shifting_work_hours.config.settings import (
...
def cmd_extract(args):
    ...
    from shifting_work_hours.pipeline import extractor
...
def cmd_wbgt_indoor(args):
    ...
    from shifting_work_hours.pipeline import wbgt_indoor
...
def cmd_wbgt_outdoor(args):
    ...
    from shifting_work_hours.pipeline import wbgt_outdoor
...
def cmd_productivity(args):
    ...
    from shifting_work_hours.pipeline import productivity
...
def cmd_analysis(args):
    ...
    from shifting_work_hours.pipeline import analysis
...
def cmd_outdoor_summary(args):
    ...
    from shifting_work_hours.pipeline import outdoor_summary
